const Footer = () => {
  return (
    <footer className="self-stretch bg-primary-dark-80 overflow-hidden flex flex-col items-center justify-center pt-[100px] px-0 pb-0 box-border gap-[100px] max-w-full text-left text-41xl-2 text-secondary-light-10 font-sub-headings-sub-heading-26px-semibold mq450:gap-[25px] mq750:gap-[50px] mq750:pt-[65px] mq750:box-border">
      <div className="w-[1280px] flex flex-row flex-wrap items-start justify-between py-0 pr-[21px] pl-5 box-border gap-[20px] max-w-full">
        <div className="flex flex-col items-start justify-start gap-[20px]">
          <div className="flex flex-row items-center justify-start gap-[13.37px]">
            <img
              className="h-10 w-[40.2px] relative"
              alt=""
              src="/stars-1.svg"
            />
        ...
        <div className="w-[847px] flex flex-col items-start justify-start gap-[60px] max-w-full text-23xl mq1050:gap-[30px]">
          ...
          <div className="self-stretch flex flex-row flex-wrap items-start justify-start py-0 pr-0.5 pl-0 gap-[10px] text-7xl">
            <div className="h-48 flex-1 flex flex-col items-start justify-start min-w-[110px]">
              <div className="self-stretch flex flex-col items-start justify-start gap-[10px]">
      ...
      <div className="self-stretch bg-secondary-dark-20 box-border flex flex-row flex-wrap items-center justify-center py-[30px] px-5 max-w-full text-lg text-secondary-light-30 font-paragraphs-para-18px-semibold border-t-[1px] border-solid border-secondary-dark-60">
        <div className="w-[914px] relative leading-[27px] font-medium inline-block shrink-0 max-w-full">
