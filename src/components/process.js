...
const Process = () => {
  return (
    <section className="self-stretch bg-secondary-light-30 overflow-hidden flex flex-col items-center justify-center py-[120px] px-5 box-border max-w-full text-center text-23xl text-secondary-dark-20 font-sub-headings-sub-heading-26px-semibold mq1050:pt-[78px] mq1050:pb-[78px] mq1050:box-border mq750:pt-[51px] mq750:pb-[51px] mq750:box-border">
