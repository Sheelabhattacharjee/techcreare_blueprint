...
const Project = () => {
  return (
    <section className="self-stretch [background:linear-gradient(180deg,_#fbf8ff,_#fff)] overflow-hidden flex flex-col items-center justify-start py-[100px] px-5 box-border max-w-full text-left text-41xl text-secondary-dark-20 font-paragraphs-para-18px-semibold mq750:pt-[27px] mq750:pb-[27px] mq750:box-border mq1250:pt-[42px] mq1250:pb-[42px] mq1250:box-border">
      <div className="w-[1240px] flex flex-col items-start justify-start gap-[60px] max-w-full mq750:gap-[30px]">
        ...
        <div className="self-stretch flex flex-row flex-wrap items-start justify-start gap-[40px] max-w-full text-base text-secondary-dark-50 mq750:gap-[20px]">
          <ColumnLeft
            para="/rectangle-73@2x.png"
            heading="FoodieFusion Event Marketing"
            textBlock="/rectangle-73-1@2x.png"
            heading1="GreenGardens Local SEO Dominance"
            reviewsFrame="/rectangle-73-2@2x.png"
